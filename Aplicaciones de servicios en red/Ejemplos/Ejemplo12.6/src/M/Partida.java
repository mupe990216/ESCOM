...
public class Partida {
    ...
    public boolean _matrizBotones[] = new boolean[40];//Sirve para la interaccion del usuario con el tablero
    public ArrayList<String> _jugadasJ1;//Nombre de las cargas encontradas por el Jugador1
    public ArrayList<String> _jugadasJ2;//Nombre de las cargas encontradas por el Jugador2
    ...
    /*
        Contructor Generico para el cliente
    */
    public Partida() {
        _idPartida = -1;
