...
public class Tablero extends JFrame implements ActionListener{
    ...
    public static JButton btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn10;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == btn1){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn1.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn1.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
            juegoLigado._Ganador="Pruebajuas jaus";
        }
        if(e.getSource() == btn2){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn2.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn2.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn3){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn3.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn3.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn4){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn4.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn4.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn5){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn5.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn5.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn6){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn6.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn6.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn7){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn7.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn7.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn8){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn8.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn8.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn9){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn9.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn9.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn10){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn10.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn10.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn11){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn11.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn11.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn12){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn12.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn12.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn13){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn13.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn13.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn14){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn14.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn14.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn15){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn15.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn15.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn16){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn16.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn16.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn17){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn17.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn17.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn18){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn18.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn18.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn19){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn19.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn19.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn20){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn20.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn20.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn21){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn21.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn21.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn22){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn22.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn22.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn23){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn23.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn23.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn24){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn24.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn24.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn25){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn25.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn25.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn26){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn26.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn26.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn27){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn27.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn27.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn28){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn28.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn28.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn29){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn29.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn29.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn30){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn30.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn30.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn31){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn31.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn31.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn32){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn32.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn32.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn33){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn33.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn33.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn34){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn34.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn34.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn35){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn35.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn35.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn36){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn36.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn36.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn37){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn37.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn37.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn38){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn38.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn38.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn39){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn39.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn39.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
        if(e.getSource() == btn40){            
            String img_a_mostrar = juegoLigado._PatronTablero.get(Integer.parseInt(btn40.getText()));
            JOptionPane.showMessageDialog(null, "Boton: "+img_a_mostrar);
            ImageIcon fondo = new ImageIcon("./img/"+img_a_mostrar);
            btn40.setIcon(new ImageIcon(fondo.getImage().getScaledInstance(110, 100, Image.SCALE_SMOOTH)));
        }
