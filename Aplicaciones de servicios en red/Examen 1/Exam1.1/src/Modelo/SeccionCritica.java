...
public class SeccionCritica extends Thread {
    ...
    */
    ...
    /*
        #Funcion getNodoSiguiente: Creada con el fin de verificar si el hilo que corra este codigo ya
          se encuentre dentro de la lista de ejecucion.
        #Entrada: nombreHilo, el cual es el ID del hilo en cuesiton
        #Salida: El Nodo Siguiente
     */
    ...
    public void BuscaArchivo(String nombreHilo, String nombreArchivo, String anterior, String Siguiente, Ventana ventanita) {
        try {
            ...
            if (AlguienYaEmpezoABuscar == true) {
                sleep(2000);
                ventanita.jta_Notificaciones.append("\t ===== Me dijo el " + anterior + " que no encontro el archivo =====\n");
            }
            sleep(2000);
            ...
            if (archivito.exists()) {//Si el archivo existe entonces paramos el bucle
                ...
                sleep(2000);
                ventanita.jta_Notificaciones.append(nombreHilo + " > Ya lo encontre, ¡PAREN DE BUSCAR! \n");                
                ...
                if (HilosUsados == MaximoHilos - 1) {//Si ya recorrimos la cantidad de hilos diponibles terminamos el bucle
                    ...
                    HiloAvisador = nombreHilo;
                    sleep(2000);
                    ventanita.jta_Notificaciones.append(nombreHilo + " > No encontre el archivo, avisare a todos lo siguiente: \n\n");
                    RespuestaFinal = "¡FRACASO! > NO SE ENCONTRO EL ARCHIVO \n";
                    ...
                    sleep(2000);
                    ventanita.jta_Notificaciones.append(nombreHilo + " > No lo encontre, vas tu: " + Siguiente + "\n");
