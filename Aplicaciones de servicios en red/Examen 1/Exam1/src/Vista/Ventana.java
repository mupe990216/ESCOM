...
public class Ventana extends JFrame {
    ...
    JScrollPane barra_scroll;

    /*
        Constructor principal
     */
    public Ventana() {
        setSize(550, 860);//Establecemos el tamaño de la ventana (Ancho, Alto)
     ...
     */
    public Ventana(String nombreHilo, int rango) {
        //setSize(550, 860);//Establecemos el tamaño de la ventana (Ancho, Alto)
    ...
    private void colocaBotones() {
        ...
        btn_Buscar.setBounds(290, 330, 200, 50);
    ...
    private void colocaAreasTexto() {
        ...
        jtf_NombreArchivo.setBounds(50, 330, 200, 50);
        ...
        jta_Notificaciones.setBounds(20, 430, 500, 380);
        ...
        barra_scroll.setBounds(20, 430, 500, 380);
